    ...
    return (
        <div className="col-sm-3">
            <div className="card" style={{width: '17rem', background: 'rgb(220, 53, 69)', margin: 5}}>
                <img className="card-img-top" src={!props.costumeImg.includes('https://spirit.scene7.com/is/image/Spirit/') ? replacementImg : props.costumeImg} alt="Card image cap"></img>
